...
import {columns} from '../InventoryTransferTable/components/InventoryTransferTableColumns'
...
function InventoryTransferTable() {
  ...
  const modalToggler = useInventoryTransferStore((state) => state.toggleOpen)
  const setModalMode = useInventoryTransferStore((state) => state.setMode)
