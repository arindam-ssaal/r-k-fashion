...
import { useAssortmentThreeData } from '../../api/useAssortmentThreeData'
import { useAssortmentThreeStore } from '../../store/useAssortmentThreeStore'
import AssortmentmanagementThreeModal from '../AssortmentmanagementThreeModal/AssortmentmanagementThreeModal'
  ...
  function AssortmentmanagementTable() {
    const { assortmentData, isLoading } = useAssortmentThreeData()
    ...
    const modalHandler = useAssortmentThreeStore((state) => state.toggleOpen)
    ...
    return (
      <div className="w-full">
        ...
        <AssortmentmanagementThreeModal/>
      </div>
    )
  }
