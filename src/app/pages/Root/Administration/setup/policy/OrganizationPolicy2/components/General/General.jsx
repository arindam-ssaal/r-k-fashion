  ...
  return (
    <div className="min-h-full bg-white">
      ...
      <div className="px-6 py-4 border-b border-gray-200 flex items-start gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-gray-800">General Settings</h1>
          <p className="text-xs text-[#6A6D70] mt-0.5">Configure settlement, billing, credit card and order policies</p>
        </div>
      </div>
      ...
      <div>
        <div className="border-l-4 border-[#0A6ED1] px-6 py-3 bg-[#EBF5FF]">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-[#0A6ED1]">Settlement & Footfall Configuration</h2>
          </div>
          <p className="text-xs text-[#6A6D70] mt-0.5 ml-4">Manage settlement days and footfall entry requirements</p>
        </div>
      ...
      <div>
        <div className="border-l-4 border-[#0A6ED1] px-6 py-3 bg-[#EBF5FF]">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#0A6ED1] inline-block"></span>
            <h2 className="text-sm font-bold text-[#0A6ED1]">Billing & Discount Configuration</h2>
          </div>
          <p className="text-xs text-[#6A6D70] mt-0.5 ml-4">Set maximum billing amounts and discount policies</p>
        </div>
      ...
      <div>
        <div className="border-l-4 border-[#0A6ED1] px-6 py-3 bg-[#EBF5FF]">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#0A6ED1] inline-block"></span>
            <h2 className="text-sm font-bold text-[#0A6ED1]">Credit Card Configuration</h2>
          </div>
          <p className="text-xs text-[#6A6D70] mt-0.5 ml-4">Configure credit card capture and authorization policies</p>
        </div>
      ...
      <div>
        <div className="border-l-4 border-[#0A6ED1] px-6 py-3 bg-[#EBF5FF]">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#0A6ED1] inline-block"></span>
            <h2 className="text-sm font-bold text-[#0A6ED1]">Back Date Entry & Picture Configuration</h2>
          </div>
          <p className="text-xs text-[#6A6D70] mt-0.5 ml-4">Configure back dated entry rules and picture capture settings</p>
        </div>
      ...
      <div>
        <div className="border-l-4 border-[#0A6ED1] px-6 py-3 bg-[#EBF5FF]">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#0A6ED1] inline-block"></span>
            <h2 className="text-sm font-bold text-[#0A6ED1]">POS Order & Stock Configuration</h2>
          </div>
          <p className="text-xs text-[#6A6D70] mt-0.5 ml-4">Configure POS order policies and stock check modes</p>
        </div>
