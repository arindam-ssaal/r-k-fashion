  ...
  return (
    <div className="min-h-full bg-white">
      ...
      <div className="px-6 py-4 border-b border-gray-200 flex items-start gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-gray-800">Goods Receipt & Return Settings</h1>
          <p className="text-xs text-[#6A6D70] mt-0.5">Configure tolerance limits and damage goods policy</p>
        </div>
      </div>

      {/* Goods Receipt Return Settings Section */}
      <div>
        <div className="border-l-4 border-[#0A6ED1] px-6 py-3 bg-[#EBF5FF]">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-[#0A6ED1]">Goods Receipt Return Settings</h2>
          </div>
          <p className="text-xs text-[#6A6D70] mt-0.5 ml-4">Configure tolerance limits and damage goods policy</p>
        </div>
