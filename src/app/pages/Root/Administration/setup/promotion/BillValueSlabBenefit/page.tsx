...
const QuantitySlabBenefit = () => {
  ...
  const fetchPromotions = () => {
    ...
    GetAPI(
      '/api/Promotion/GetAllPromotion?promotionType=B',
      '',
      { PromotionID: 0 },
      {}
    )
          ...
          <div className="flex flex-col h-screen" style={{background: '#d6eaf8'}}>
            ...
            <DialogHeader className="px-6 py-4 border-b flex-shrink-0 shadow-sm">
              <DialogTitle className="text-xl font-semibold" style={{color: 'black'}}>
                {editPromotion
                  ? isViewMode
                    ? 'View Promotion Setup - Bill Value Slab Based'
                    : 'Edit Promotion Setup - Bill Value Slab Based'
                  : 'Create Promotion Setup - Bill Value Slab Based'}
              </DialogTitle>
            </DialogHeader>
                ...
                <div className=" border border-gray-200 rounded-lg p-6 shadow-sm">
                  ...
                  <div className="space-y-4 mt-6">
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-3">
                        <RadioGroupItem value="B" id="bill-value-slab" />
                        <Label htmlFor="bill-value-slab" className="text-sm font-normal cursor-pointer" style={{color: 'black'}}>
                    ...
                    <div className="overflow-x-auto">
                      <Table className="[&_tr:hover]:bg-transparent">
                        <TableHeader>
                          <TableRow>
                            <TableHead className="w-[50px]" style={{color: 'black'}}>No.</TableHead>
                            <TableHead style={{color: 'black'}}>From Value</TableHead>
                            <TableHead style={{color: 'black'}}>To Value</TableHead>
                            <TableHead className="w-[60px] text-center" style={{color: 'black'}}>Delete</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
