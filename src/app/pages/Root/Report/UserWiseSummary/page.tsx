  ...
  */
  ...
  const handleBillPrint = () => {
    ...
    setTimeout(() => {
      ...
      const report_id = 8;
      const url = `${import.meta.env.VITE_SERVER_DEV_REPORT}/web/WebForm1.aspx?id1=${report_id}&id2=${fromDateFormatted}|${toDateFormatted}|1&id3=2&uid=${UserId}`;
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button
              ...
              onClick={() => {
                ...
                setSelectedUsers(userList.map((u) => u.id)) // Reset to all users selected
                setPrint(false)
                setReportUrl('')
              }}
            >
      ...
      <div className="border border-gray-300 shadow-sm rounded-lg p-6 max-w-full mx-auto mb-8" style={{background: 'white'}}>
        ...
        <div className="h-screen border border-dashed border-gray-300 rounded-lg p-4" style={{background: 'white'}}>
          {print && reportUrl ? (
            <iframe
              src={reportUrl}
              title="User Wise Summary Report"
...
export default UserWiseSummaryPage