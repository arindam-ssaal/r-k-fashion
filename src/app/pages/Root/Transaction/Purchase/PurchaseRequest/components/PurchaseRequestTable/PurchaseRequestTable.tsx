...
import columns from '../PurchaseRequestColumn'
...
function PurchaseRequestTable() {
  ...
  const modalToggler = usePurchaseRequestType((state) => state.toggleOpen)
  const setModalMode = usePurchaseRequestType((state) => state.setMode)
