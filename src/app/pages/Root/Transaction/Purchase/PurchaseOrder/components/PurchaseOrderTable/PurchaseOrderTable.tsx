...
import columns from '../PurchaseOrderColumn'
...
function PurchaseOrderTable() {
  ...
  const modalToggler = usePurchaseOrderType((state) => state.toggleOpen)
  const setModalMode = usePurchaseOrderType((state) => state.setMode)
