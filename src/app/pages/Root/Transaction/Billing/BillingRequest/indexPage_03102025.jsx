...
const BillingRequest = () => {
  ...
  */
  ...
  ? storedDiscount.appliedOn === "I"
    ...
    : (() => {
          ...
          if (isCouponApplied && coupon1Code && coupon2Code && baseTotal >= 1500) {
  ...
  */  
  ...
  const handleSaveBill = async () => {
    ...
    const formData = {
      ...
      billBasicAmt: 0,
      billGrossAmt: 0,
      billDiscAmt: (coupon1Code && coupon2Code) ? 100 : 0, //0,
      billNetAmt: 0,
      billChargeAmt: 0,
      billRoundoffAmt: 0,
  ...
  */
  ...
  const handleApplyCoupon = () => {
    if (coupon1Code && coupon2Code && totalBillAmount >= 1500) {
                  ...
                  <div className="border p-3 rounded-lg shadow-sm mt-2">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-3">
                      ...
                      <div className="flex flex-col">
                        <label className="text-sm font-medium mb-1">Coupon 1</label>
                        <input
                          type="text"
                          value={coupon1Code}
                          ...
                          placeholder="Enter Coupon 1 code"
                        />
                      </div>
                      {/* Coupon 2 */}
                      <div className="flex flex-col">
                    ...
                    <div className="flex justify-end">
                      <Button
                        ...
                        disabled={isCouponApplied || !(coupon1Code && coupon2Code && totalBillAmount >= 1500)}
