...
const FootFall = () => {
    ...
    const chartData = slotListData.map((slot) => ({
        time: formatSlotDesc(slot),
        selectedRange: Number(apiFootfallValues[slot.slotID] || 0),
        todayFootfall: Number(footfallValues[slot.slotID] || 0),
    }))
    ...
    return (
            ...
            <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData}>
                    ...
                    <Area
                        ...
                        name="Selected Range Footfall"
                        stroke="rgba(54, 162, 235, 1)"
                        fill="rgba(54, 162, 235, 0.2)"
                    />
                    <Area
                        type="monotone"
                        dataKey="todayFootfall"
                        name="Today Footfall"
        ...
        <div className="relative overflow-x-auto pb-2 mt-16">
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="" style={{ backgroundColor: '#fff' }}>
                <tr>
                ...
                <tbody className="divide-y divide-gray-200 " style={{ backgroundColor: '#fff' }}>
                <tr>
                    {slotListData.map((slot) => (
                    <td key={slot.slotID} className="whitespace-nowrap px-4 py-4 text-sm text-gray-900">
                        ...
                        onChange={(e) =>
                            ...
                            ...prev,
                            [slot.slotID]: e.target.value.replace(/\D/g, ''),
                            }))
                        }
