// DataTableLight.jsx – Reusable data-table component with light color scheme
// Dependencies: React
import { useState, useEffect, useRef } from "react";

// ============================================================
// CSS STYLES (light theme)
// ============================================================
const DT_STYLES = `
  ...
  .sdt-root {
    ...
    --sdt-text: #1f2937; --sdt-text-muted: #6b7280;
    --sdt-border: #cbd5e1; --sdt-bg: #ffffff; --sdt-white: #ffffff;
    --sdt-input-border: #cbd5e1;
    --sdt-error: #ef4444; --sdt-success: #22c55e; --sdt-warning: #f59e0b;
    --sdt-row-hover: #f8fafc; --sdt-row-selected: #e0f2fe;
    --sdt-radius: 4px; --sdt-shadow: 0 2px 8px rgba(0,0,0,0.08);
  ...
  .sdt-toolbar { display: flex; align-items: center; gap: 8px; padding: 10px 24px; background: #ffffff; border-bottom: 1px solid var(--sdt-border); flex-wrap: wrap; flex-shrink: 0; }
  ...
  .sdt-search-input { height: 32px; border: 1px solid var(--sdt-input-border); border-radius: var(--sdt-radius); padding: 0 10px 0 34px; font-size: 13px; color: var(--sdt-text); background: #ffffff; outline: none; width: 260px; font-family: inherit; }
  .sdt-search-input:focus { border-color: var(--sdt-brand); box-shadow: 0 0 0 2px rgba(0,137,181,.15); }
  ...
  .sdt-btn-ghost { background: #ffffff; color: var(--sdt-text); border-color: var(--sdt-border); }
  .sdt-btn-ghost:hover { background: #f8fafc; border-color: var(--sdt-input-border); }
  .sdt-btn-danger { background: #ffffff; color: var(--sdt-error); border-color: var(--sdt-error); }
  .sdt-btn-danger:hover { background: rgba(239,68,68,0.1); }
  .sdt-btn-success { background: #ffffff; color: var(--sdt-success); border-color: var(--sdt-success); }
  .sdt-btn-success:hover { background: rgba(34,197,94,0.1); }
  .sdt-btn-warning { background: #ffffff; color: var(--sdt-warning); border-color: var(--sdt-warning); }
  .sdt-btn-warning:hover { background: rgba(245,158,11,0.1); }
  ...
  .sdt-filter-bar { display: flex; padding: 10px 24px; background: #d6eaf8; border-bottom: 1px solid var(--sdt-border); gap: 10px; flex-wrap: wrap; align-items: flex-end; flex-shrink: 0; }
  ...
  .sdt-filter-group select, .sdt-filter-group input { height: 28px; border: 1px solid var(--sdt-input-border); border-radius: var(--sdt-radius); padding: 0 8px; font-size: 12px; color: var(--sdt-text); outline: none; font-family: inherit; background: #ffffff; }
  .sdt-filter-group select:focus, .sdt-filter-group input:focus { border-color: var(--sdt-brand); }

  .sdt-filter-tags { display: flex; align-items: center; gap: 6px; flex-wrap: wrap; padding: 6px 24px; background: #d6eaf8; border-bottom: 1px solid var(--sdt-border); }
  ...
  .sdt-table-area { flex: 1; overflow: auto; padding: 16px 24px; background: #d6eaf8; }
  .sdt-table-card { background: var(--sdt-white); border: 1px solid var(--sdt-border); border-radius: var(--sdt-radius); overflow: hidden; box-shadow: var(--sdt-shadow); }

  .sdt-root table { width: 100%; border-collapse: collapse; }
  .sdt-root thead th { background: #ffffff; color: var(--sdt-text); font-size: 12px; font-weight: 600; padding: 10px 12px; text-align: left; border-bottom: 2px solid var(--sdt-border); white-space: nowrap; position: sticky; top: 0; z-index: 2; }
  .sdt-root thead th.sdt-sortable { cursor: pointer; user-select: none; }
  .sdt-root thead th.sdt-sortable:hover { background: #f8fafc; color: var(--sdt-brand); }
  ...
  .sdt-root tbody tr:hover { background: var(--sdt-row-hover); }
  ...
  .sdt-action-btn.sdt-action-danger:hover { background: rgba(239,68,68,0.1); color: var(--sdt-error); }
  .sdt-action-btn.sdt-action-warning:hover { background: rgba(245,158,11,0.1); color: var(--sdt-warning); }
  .sdt-action-btn.sdt-action-success:hover { background: rgba(34,197,94,0.1); color: var(--sdt-success); }

  .sdt-table-footer { display: flex; align-items: center; justify-content: space-between; padding: 10px 16px; background: #ffffff; border-top: 1px solid var(--sdt-border); gap: 12px; flex-wrap: wrap; }
  ...
  .sdt-pg-btn { height: 28px; min-width: 28px; padding: 0 8px; border: 1px solid var(--sdt-border); border-radius: var(--sdt-radius); background: #ffffff; font-size: 12px; cursor: pointer; color: var(--sdt-text); transition: all .12s; display: inline-flex; align-items: center; justify-content: center; font-family: inherit; }
  .sdt-pg-btn:hover:not(:disabled) { border-color: var(--sdt-brand); color: var(--sdt-brand); background: rgba(0,137,181,0.05); }
  ...
  .sdt-page-size-wrap select { height: 28px; border: 1px solid var(--sdt-border); border-radius: var(--sdt-radius); padding: 0 6px; font-size: 12px; outline: none; font-family: inherit; background: #ffffff; color: var(--sdt-text); }

  .sdt-col-chooser-wrap { position: relative; }
  .sdt-col-chooser { position: absolute; right: 0; top: 36px; background: #ffffff; border: 1px solid var(--sdt-border); border-radius: var(--sdt-radius); box-shadow: 0 4px 16px rgba(0,0,0,0.1); padding: 12px; min-width: 180px; z-index: 50; }
...
export default function DataTableLight({
  columns,
  rowData,
  rowIdField = "id",
